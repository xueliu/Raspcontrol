<?php
	class versionCheck {
		function checkVersion(){
		    $version = "0.4"; //Version of the script, to check against CSV
		    ...
		    if ($critical) { 
		        print '<font color="red"> &middot There is a critical update available (Version: '.$read[0].')!</font><br/>You can get it at <a href="'.$read[3].'">'.$read[3].'</a> (Description: '.$read[1].') <br/><br/>';
		    }else if ($update){
		        print '<font color="green"> &middot There is a none critical update available (Version: '.$read[0].')!</font><br/>You can get it at <a href="'.$read[3].'">'.$read[3].'</a> (Description: '.$read[1].') <br/><br/>';
		    }
